...
import id.liostech.springpus.exception.StorageException;
import id.liostech.springpus.exception.StorageFileNotFoundException;
...
public class FileService {
    ...
    public UrlResource loadAsResource(String filename) throws StorageFileNotFoundException {
        try {
